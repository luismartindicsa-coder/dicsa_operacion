        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const _FinDirectorySectionHeader(label: 'AREA'),
              const SizedBox(height: 8),
              Container(
              ...
              const SizedBox(height: 14),
              const _FinDirectorySectionHeader(label: 'ACCESOS'),
              const SizedBox(height: 8),
              if (canReturnToDirection) ...[
                _FinDirectoryNavItem(
...
class _FinDirectorySectionHeader extends StatelessWidget {
  final String label;
  const _FinDirectorySectionHeader({required this.label});
...
class _FinDirectoryNavItem extends StatelessWidget {
  final IconData icon;
  final String title;
  final String? subtitle;
  final bool accented;
  final Future<void> Function() onTap;
  const _FinDirectoryNavItem({
    required this.icon,
    required this.title,
    this.subtitle,
    this.accented = false,
