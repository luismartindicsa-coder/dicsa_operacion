...
_ConceptConfig _conceptConfigFromCatalog(MayoreoCashConceptDefinition concept) {
  return _ConceptConfig(
    ...
    requiresSubconcept: concept.requiresSubconcept,
...
class _VoucherEditorDialogState extends State<_VoucherEditorDialog> {
  ...
  List<_ConceptConfig> _conceptOptionsForRubric() {
    return (_voucherConfigFromCatalog()[_type] ??
            const <String, List<_ConceptConfig>>{})[_rubric] ??
        const <_ConceptConfig>[];
  }
