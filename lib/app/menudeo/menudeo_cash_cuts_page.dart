...
class _CashCutEditorDialogState extends State<_CashCutEditorDialog> {
  ...
  Future<Uint8List> _buildCashCutPrintPdfBytes() async {
    ...
    final opening = _parseMoney(_openingC);
    final sales = _parseMoney(_salesC);
    final purchases = _parseMoney(_purchasesC);
    final deposits = _parseMoney(_depositsC);
    final expenses = _parseMoney(_expensesC);
    final counted = _parseMoney(_countedC);
  ...
  Future<void> _openCashCutPdf() async {
    ...
    try {
      ...
      final file = File(
        '${Directory.systemTemp.path}/menudeo_corte_caja_historial_$stamp.pdf',
      );
                ...
                return Column(
                  ...
                  children: [
                    _CutDialogHeader(
                      ...
                      onPrint: widget.initial == null ? null : _openCashCutPdf,
