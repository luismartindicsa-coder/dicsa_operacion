                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Informacion diaria consolidada del colaborador antes de permisos, vacaciones y prenomina.',
                            style: TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.w700,
                              color: Color(0xFF6E47A8),
...
class _HrAttendanceStatusChip extends StatelessWidget {
  final String label;
  final bool complete;

  const _HrAttendanceStatusChip({required this.label, required this.complete});
