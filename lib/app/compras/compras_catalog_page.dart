...
class ComprasCatalogPage extends StatefulWidget {
  final bool instantOpen;

  const ComprasCatalogPage({super.key, this.instantOpen = false});

  @override
  State<ComprasCatalogPage> createState() => _ComprasCatalogPageState();
}

class _ComprasCatalogPageState extends State<ComprasCatalogPage>
  ...
  void _setupAutoRefresh() {
    ...
    _catalogRealtimeChannel = Supabase.instance.client
        .channel('compras-catalog-auto-refresh')
        .onPostgresChanges(
  ...
  Future<void> _pickMaterialCategoryFilter() async {
    final selected = await _showMayoreoMultiSelectDialog<String>(
      ...
      options: _kComprasGeneralCategories
      ...
      child: Column(
        children: [
          _CatalogFilterSummaryRow(
            labels: [
              for (final company in _companyNameFilters) 'Proveedor: $company',
      ...
      child: Column(
        children: [
          ...
          _CatalogFilterSummaryRow(
            labels: [
              if (_priceCompanyFilterId != null)
                'Proveedor: ${_companyName(_priceCompanyFilterId!)}',
              if (_priceMaterialFilterId != null)
        ...
        _CatalogInlineFieldCell(
          ...
          child: level == 'GENERAL'
              ...
              : _CatalogDropdownField<String>(
                  ...
                  hint: 'Familia',
                  items: _kComprasGeneralCategories,
                  onChanged: (value) {
              ...
              Expanded(
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: value == null ? kComprasMutedInk : kComprasInk,
                  ),
                ),
              ),
              const SizedBox(width: 8),
