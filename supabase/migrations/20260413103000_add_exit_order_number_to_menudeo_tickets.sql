...
alter table public.men_tickets
  add column if not exists exit_order_number text;
...
comment on column public.men_tickets.exit_order_number is
  'Numero de orden de salida asociado a la venta, capturado al confirmar la salida.';
