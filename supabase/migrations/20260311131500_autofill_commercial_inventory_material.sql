...
drop trigger if exists trg_autofill_commercial_inventory_material
  on public.commercial_material_catalog;

create trigger trg_autofill_commercial_inventory_material
before insert or update of code, material_id, inventory_material
on public.commercial_material_catalog
for each row
execute function public.fn_autofill_commercial_inventory_material();
