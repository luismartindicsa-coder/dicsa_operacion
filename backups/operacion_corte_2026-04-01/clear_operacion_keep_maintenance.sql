...
-- select count(*) from public.inventory_movements_v2;
-- select count(*) from public.inventory_opening_balances_v2;
-- select count(*) from public.material_transformation_runs_v2;
-- select count(*) from public.material_transformation_run_outputs_v2;
-- select count(*) from public.pesadas;
-- select count(*) from public.movements;
-- select count(*) from public.production_runs;
-- select count(*) from public.material_separation_runs;
-- select count(*) from public.opening_balances;
